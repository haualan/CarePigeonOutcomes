...
# JTnguyen hss
user_access_token = 'bf2027eeaebdb6c9322f61e195928d43'
user_access_token_secret = '4d674ea7929be5aff651e2922a530d83'
encoded_userid = '28K8M5'
...
def getStepsTimeSeries(timeChoice = '1m'):
  choices = ['1d', '7d', '30d', '1w', '1m', '3m', '6m', '1y']
  if not (timeChoice in choices):
    timeChoice = '1m'
  api_url = '/1/user/-/activities/steps/date/today/{}.json'.format(timeChoice)
  r = reqAPI(api_url)
  try:
    result = []
    print r
    for i in r['activities-steps']:
      result.append((i['dateTime'], int(i['value'])))
    return result
